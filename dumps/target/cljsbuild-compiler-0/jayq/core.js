...
;
jQuery.prototype.apply = (function (self__,args4975){
...
var hide__delegate = function ($elem,p__4977){
var vec__4979 = p__4977;
var speed = cljs.core.nth.call(null,vec__4979,0,null);
var on_finish = cljs.core.nth.call(null,vec__4979,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4977 = null;
if (goog.isDef(var_args)) {
  p__4977 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__4977);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__4980){
var $elem = cljs.core.first(arglist__4980);
var p__4977 = cljs.core.rest(arglist__4980);
return hide__delegate($elem, p__4977);
});
...
var show__delegate = function ($elem,p__4981){
var vec__4983 = p__4981;
var speed = cljs.core.nth.call(null,vec__4983,0,null);
var on_finish = cljs.core.nth.call(null,vec__4983,1,null);
...
return show__delegate.call(this, $elem, p__4981);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__4984){
var $elem = cljs.core.first(arglist__4984);
var p__4981 = cljs.core.rest(arglist__4984);
return show__delegate($elem, p__4981);
});
...
var toggle__delegate = function ($elem,p__4985){
var vec__4987 = p__4985;
var speed = cljs.core.nth.call(null,vec__4987,0,null);
var on_finish = cljs.core.nth.call(null,vec__4987,1,null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__4985 = null;
if (goog.isDef(var_args)) {
  p__4985 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this, $elem, p__4985);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__4988){
var $elem = cljs.core.first(arglist__4988);
var p__4985 = cljs.core.rest(arglist__4988);
return toggle__delegate($elem, p__4985);
});
...
var fade_out__delegate = function ($elem,p__4989){
var vec__4991 = p__4989;
var speed = cljs.core.nth.call(null,vec__4991,0,null);
var on_finish = cljs.core.nth.call(null,vec__4991,1,null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4989 = null;
if (goog.isDef(var_args)) {
  p__4989 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this, $elem, p__4989);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__4992){
var $elem = cljs.core.first(arglist__4992);
var p__4989 = cljs.core.rest(arglist__4992);
return fade_out__delegate($elem, p__4989);
});
...
var fade_in__delegate = function ($elem,p__4993){
var vec__4995 = p__4993;
var speed = cljs.core.nth.call(null,vec__4995,0,null);
var on_finish = cljs.core.nth.call(null,vec__4995,1,null);
return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__4993 = null;
if (goog.isDef(var_args)) {
  p__4993 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_in__delegate.call(this, $elem, p__4993);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__4996){
var $elem = cljs.core.first(arglist__4996);
var p__4993 = cljs.core.rest(arglist__4996);
return fade_in__delegate($elem, p__4993);
});
...
var slide_up__delegate = function ($elem,p__4997){
var vec__4999 = p__4997;
var speed = cljs.core.nth.call(null,vec__4999,0,null);
var on_finish = cljs.core.nth.call(null,vec__4999,1,null);
return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__4997 = null;
if (goog.isDef(var_args)) {
  p__4997 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_up__delegate.call(this, $elem, p__4997);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__5000){
var $elem = cljs.core.first(arglist__5000);
var p__4997 = cljs.core.rest(arglist__5000);
return slide_up__delegate($elem, p__4997);
});
...
var slide_down__delegate = function ($elem,p__5001){
var vec__5003 = p__5001;
var speed = cljs.core.nth.call(null,vec__5003,0,null);
var on_finish = cljs.core.nth.call(null,vec__5003,1,null);
return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__5001 = null;
if (goog.isDef(var_args)) {
  p__5001 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_down__delegate.call(this, $elem, p__5001);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__5004){
var $elem = cljs.core.first(arglist__5004);
var p__5001 = cljs.core.rest(arglist__5004);
return slide_down__delegate($elem, p__5001);
});
...
var closest__delegate = function ($elem,selector,p__5005){
var vec__5007 = p__5005;
var context = cljs.core.nth.call(null,vec__5007,0,null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__5005 = null;
if (goog.isDef(var_args)) {
  p__5005 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this, $elem, selector, p__5005);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__5008){
var $elem = cljs.core.first(arglist__5008);
var selector = cljs.core.first(cljs.core.next(arglist__5008));
var p__5005 = cljs.core.rest(cljs.core.next(arglist__5008));
return closest__delegate($elem, selector, p__5005);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__5011){
var map__5013 = p__5011;
var map__5013__$1 = ((cljs.core.seq_QMARK_.call(null,map__5013))?cljs.core.apply.call(null,cljs.core.hash_map,map__5013):map__5013);
var request = map__5013__$1;
var contentType = cljs.core._lookup.call(null,map__5013__$1,"\uFDD0:contentType",null);
var data = cljs.core._lookup.call(null,map__5013__$1,"\uFDD0:data",null);
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__5010_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__5010_SHARP_,"\uFDD0:data",cljs.core.pr_str.call(null,data));
} else
{return p1__5010_SHARP_;
}
}).call(null,(function (p1__5009_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__5009_SHARP_,"\uFDD0:contentType",ct);
} else
{return p1__5009_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__5014,content,callback){
var vec__5016 = p__5014;
var method = cljs.core.nth.call(null,vec__5016,0,null);
var uri = cljs.core.nth.call(null,vec__5016,1,null);
...
var unbind__delegate = function ($elem,ev,p__5017){
var vec__5019 = p__5017;
var func = cljs.core.nth.call(null,vec__5019,0,null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__5017 = null;
if (goog.isDef(var_args)) {
  p__5017 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this, $elem, ev, p__5017);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__5020){
var $elem = cljs.core.first(arglist__5020);
var ev = cljs.core.first(cljs.core.next(arglist__5020));
var p__5017 = cljs.core.rest(cljs.core.next(arglist__5020));
return unbind__delegate($elem, ev, p__5017);
});
...
var on__delegate = function ($elem,events,p__5021){
var vec__5023 = p__5021;
var sel = cljs.core.nth.call(null,vec__5023,0,null);
var data = cljs.core.nth.call(null,vec__5023,1,null);
var handler = cljs.core.nth.call(null,vec__5023,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__5021 = null;
if (goog.isDef(var_args)) {
  p__5021 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__5021);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__5024){
var $elem = cljs.core.first(arglist__5024);
var events = cljs.core.first(cljs.core.next(arglist__5024));
var p__5021 = cljs.core.rest(cljs.core.next(arglist__5024));
return on__delegate($elem, events, p__5021);
});
...
var one__delegate = function ($elem,events,p__5025){
var vec__5027 = p__5025;
var sel = cljs.core.nth.call(null,vec__5027,0,null);
var data = cljs.core.nth.call(null,vec__5027,1,null);
var handler = cljs.core.nth.call(null,vec__5027,2,null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__5025 = null;
if (goog.isDef(var_args)) {
  p__5025 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this, $elem, events, p__5025);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__5028){
var $elem = cljs.core.first(arglist__5028);
var events = cljs.core.first(cljs.core.next(arglist__5028));
var p__5025 = cljs.core.rest(cljs.core.next(arglist__5028));
return one__delegate($elem, events, p__5025);
});
...
var off__delegate = function ($elem,events,p__5029){
var vec__5031 = p__5029;
var sel = cljs.core.nth.call(null,vec__5031,0,null);
var handler = cljs.core.nth.call(null,vec__5031,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__5029 = null;
if (goog.isDef(var_args)) {
  p__5029 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__5029);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__5032){
var $elem = cljs.core.first(arglist__5032);
var events = cljs.core.first(cljs.core.next(arglist__5032));
var p__5029 = cljs.core.rest(cljs.core.next(arglist__5032));
return off__delegate($elem, events, p__5029);
});
...
done.cljs$lang$applyTo = (function (arglist__5033){
var deferred = cljs.core.first(arglist__5033);
var fns_args = cljs.core.rest(arglist__5033);
...
fail.cljs$lang$applyTo = (function (arglist__5034){
var deferred = cljs.core.first(arglist__5034);
var fns_args = cljs.core.rest(arglist__5034);
...
always.cljs$lang$applyTo = (function (arglist__5035){
var deferred = cljs.core.first(arglist__5035);
var fns_args = cljs.core.rest(arglist__5035);

...
}catch (e4125){if(cljs.core.instance_QMARK_.call(null,Error,e4125))
{var e = e4125;
...
clojure.browser.net.register_service.call(null,repl_connection,"\uFDD0:evaluate-javascript",(function (js__$1){
return clojure.browser.net.transmit.call(null,repl_connection,"\uFDD0:send-result",clojure.browser.repl.evaluate_javascript.call(null,repl_connection,js__$1));
}));

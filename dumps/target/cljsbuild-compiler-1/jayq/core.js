...
;
jQuery.prototype.apply = (function (self__,args4142){
...
var hide__delegate = function ($elem,p__4144){
var vec__4146 = p__4144;
var speed = cljs.core.nth.call(null,vec__4146,0,null);
var on_finish = cljs.core.nth.call(null,vec__4146,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4144 = null;
if (goog.isDef(var_args)) {
  p__4144 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__4144);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__4147){
var $elem = cljs.core.first(arglist__4147);
var p__4144 = cljs.core.rest(arglist__4147);
return hide__delegate($elem, p__4144);
});
...
var show__delegate = function ($elem,p__4148){
var vec__4150 = p__4148;
var speed = cljs.core.nth.call(null,vec__4150,0,null);
var on_finish = cljs.core.nth.call(null,vec__4150,1,null);
...
return show__delegate.call(this, $elem, p__4148);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__4151){
var $elem = cljs.core.first(arglist__4151);
var p__4148 = cljs.core.rest(arglist__4151);
return show__delegate($elem, p__4148);
});
...
var toggle__delegate = function ($elem,p__4152){
var vec__4154 = p__4152;
var speed = cljs.core.nth.call(null,vec__4154,0,null);
var on_finish = cljs.core.nth.call(null,vec__4154,1,null);
...
return toggle__delegate.call(this, $elem, p__4152);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__4155){
var $elem = cljs.core.first(arglist__4155);
var p__4152 = cljs.core.rest(arglist__4155);
return toggle__delegate($elem, p__4152);
});
...
var fade_out__delegate = function ($elem,p__4156){
var vec__4158 = p__4156;
var speed = cljs.core.nth.call(null,vec__4158,0,null);
var on_finish = cljs.core.nth.call(null,vec__4158,1,null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4156 = null;
if (goog.isDef(var_args)) {
  p__4156 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this, $elem, p__4156);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__4159){
var $elem = cljs.core.first(arglist__4159);
var p__4156 = cljs.core.rest(arglist__4159);
return fade_out__delegate($elem, p__4156);
});
...
var fade_in__delegate = function ($elem,p__4160){
var vec__4162 = p__4160;
var speed = cljs.core.nth.call(null,vec__4162,0,null);
var on_finish = cljs.core.nth.call(null,vec__4162,1,null);
...
return fade_in__delegate.call(this, $elem, p__4160);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__4163){
var $elem = cljs.core.first(arglist__4163);
var p__4160 = cljs.core.rest(arglist__4163);
return fade_in__delegate($elem, p__4160);
});
...
var slide_up__delegate = function ($elem,p__4164){
var vec__4166 = p__4164;
var speed = cljs.core.nth.call(null,vec__4166,0,null);
var on_finish = cljs.core.nth.call(null,vec__4166,1,null);
return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__4164 = null;
if (goog.isDef(var_args)) {
  p__4164 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_up__delegate.call(this, $elem, p__4164);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__4167){
var $elem = cljs.core.first(arglist__4167);
var p__4164 = cljs.core.rest(arglist__4167);
return slide_up__delegate($elem, p__4164);
});
...
var slide_down__delegate = function ($elem,p__4168){
var vec__4170 = p__4168;
var speed = cljs.core.nth.call(null,vec__4170,0,null);
var on_finish = cljs.core.nth.call(null,vec__4170,1,null);
return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__4168 = null;
if (goog.isDef(var_args)) {
  p__4168 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_down__delegate.call(this, $elem, p__4168);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__4171){
var $elem = cljs.core.first(arglist__4171);
var p__4168 = cljs.core.rest(arglist__4171);
return slide_down__delegate($elem, p__4168);
});
...
var closest__delegate = function ($elem,selector,p__4172){
var vec__4174 = p__4172;
var context = cljs.core.nth.call(null,vec__4174,0,null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__4172 = null;
if (goog.isDef(var_args)) {
  p__4172 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this, $elem, selector, p__4172);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__4175){
var $elem = cljs.core.first(arglist__4175);
var selector = cljs.core.first(cljs.core.next(arglist__4175));
var p__4172 = cljs.core.rest(cljs.core.next(arglist__4175));
return closest__delegate($elem, selector, p__4172);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__4178){
var map__4180 = p__4178;
var map__4180__$1 = ((cljs.core.seq_QMARK_.call(null,map__4180))?cljs.core.apply.call(null,cljs.core.hash_map,map__4180):map__4180);
var request = map__4180__$1;
var contentType = cljs.core._lookup.call(null,map__4180__$1,"\uFDD0:contentType",null);
var data = cljs.core._lookup.call(null,map__4180__$1,"\uFDD0:data",null);
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__4177_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__4177_SHARP_,"\uFDD0:data",cljs.core.pr_str.call(null,data));
} else
{return p1__4177_SHARP_;
}
}).call(null,(function (p1__4176_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__4176_SHARP_,"\uFDD0:contentType",ct);
} else
{return p1__4176_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__4181,content,callback){
var vec__4183 = p__4181;
var method = cljs.core.nth.call(null,vec__4183,0,null);
var uri = cljs.core.nth.call(null,vec__4183,1,null);
...
var unbind__delegate = function ($elem,ev,p__4184){
var vec__4186 = p__4184;
var func = cljs.core.nth.call(null,vec__4186,0,null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__4184 = null;
if (goog.isDef(var_args)) {
  p__4184 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this, $elem, ev, p__4184);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__4187){
var $elem = cljs.core.first(arglist__4187);
var ev = cljs.core.first(cljs.core.next(arglist__4187));
var p__4184 = cljs.core.rest(cljs.core.next(arglist__4187));
return unbind__delegate($elem, ev, p__4184);
});
...
var on__delegate = function ($elem,events,p__4188){
var vec__4190 = p__4188;
var sel = cljs.core.nth.call(null,vec__4190,0,null);
var data = cljs.core.nth.call(null,vec__4190,1,null);
var handler = cljs.core.nth.call(null,vec__4190,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__4188 = null;
if (goog.isDef(var_args)) {
  p__4188 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__4188);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__4191){
var $elem = cljs.core.first(arglist__4191);
var events = cljs.core.first(cljs.core.next(arglist__4191));
var p__4188 = cljs.core.rest(cljs.core.next(arglist__4191));
return on__delegate($elem, events, p__4188);
});
...
var one__delegate = function ($elem,events,p__4192){
var vec__4194 = p__4192;
var sel = cljs.core.nth.call(null,vec__4194,0,null);
var data = cljs.core.nth.call(null,vec__4194,1,null);
var handler = cljs.core.nth.call(null,vec__4194,2,null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__4192 = null;
if (goog.isDef(var_args)) {
  p__4192 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this, $elem, events, p__4192);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__4195){
var $elem = cljs.core.first(arglist__4195);
var events = cljs.core.first(cljs.core.next(arglist__4195));
var p__4192 = cljs.core.rest(cljs.core.next(arglist__4195));
return one__delegate($elem, events, p__4192);
});
...
var off__delegate = function ($elem,events,p__4196){
var vec__4198 = p__4196;
var sel = cljs.core.nth.call(null,vec__4198,0,null);
var handler = cljs.core.nth.call(null,vec__4198,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__4196 = null;
if (goog.isDef(var_args)) {
  p__4196 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__4196);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__4199){
var $elem = cljs.core.first(arglist__4199);
var events = cljs.core.first(cljs.core.next(arglist__4199));
var p__4196 = cljs.core.rest(cljs.core.next(arglist__4199));
return off__delegate($elem, events, p__4196);
});
...
done.cljs$lang$applyTo = (function (arglist__4200){
var deferred = cljs.core.first(arglist__4200);
var fns_args = cljs.core.rest(arglist__4200);
...
fail.cljs$lang$applyTo = (function (arglist__4201){
var deferred = cljs.core.first(arglist__4201);
var fns_args = cljs.core.rest(arglist__4201);
...
always.cljs$lang$applyTo = (function (arglist__4202){
var deferred = cljs.core.first(arglist__4202);
var fns_args = cljs.core.rest(arglist__4202);
